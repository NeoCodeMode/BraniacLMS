...
class TestNewsSelenium(StaticLiveServerTestCase):
    ...
    def setUp(self):
        ...
        userName = WebDriverWait(self.selenium, 10).until(EC.visibility_of_element_located((By.ID, "id_username")))
        userName.send_keys(username)

        passWord = WebDriverWait(self.selenium, 10).until(EC.visibility_of_element_located((By.ID, "id_password")))
